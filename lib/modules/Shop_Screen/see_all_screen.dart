...
import 'package:online_groceries_app/modules/Shop_Screen/item_details.dart';
...
class SeeAllScreen extends StatelessWidget {
  ...
  final List list;
  const SeeAllScreen({Key? key, required this.appBarName, required this.list}) : super(key: key);
